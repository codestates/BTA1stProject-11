...
import { addMissingProofs, addMissingSignatures, zkappCommandToJson, AccountUpdate, ZkappStateLength, TokenId, CallForest, Authorization, SequenceEvents, } from './account_update.js';
...
function createTransaction(feePayer, f, { fetchMode = 'cached', isFinalRunOutsideCircuit = true } = {}) {
    ...
    if (feePayerKey !== undefined) {
        ...
        feePayerAccountUpdate = AccountUpdate.defaultFeePayer(senderAddress, feePayerKey, senderAccount.nonce);
        if (fee !== undefined) {
